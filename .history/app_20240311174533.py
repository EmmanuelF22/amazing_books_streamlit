...
st.markdown('<h1 style="text-align: color: green; center;">Amazing Books</h1>', unsafe_allow_html=True)
...
with col2:
    st.title(f"""Tell us what you thought of the book...""")
    st.title(f"""we'll tell you if you like it!""")
